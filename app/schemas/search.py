...
class BaseSearchResult(BaseModel):
    ...
    snippet: Optional[str] = Field(default=None, description="Result description/snippet")
...
class WebSearchResult(BaseSearchResult):
    ...
    cached_url: Optional[HttpUrl] = Field(default=None, description="Cached version URL")
    file_format: Optional[str] = Field(default=None, description="File format if applicable")
    formatted_url: Optional[str] = Field(default=None, description="Formatted URL")
    html_formatted_url: Optional[str] = Field(default=None, description="HTML formatted URL")
    html_snippet: Optional[str] = Field(default=None, description="HTML formatted snippet")
    html_title: Optional[str] = Field(default=None, description="HTML formatted title")
    mime_type: Optional[str] = Field(default=None, description="MIME type")
    page_map: Optional[Dict[str, Any]] = Field(default=None, description="Page metadata")
...
class ImageSearchResult(BaseSearchResult):
    ...
    thumbnail_height: Optional[int] = Field(default=None, description="Thumbnail height")
    thumbnail_width: Optional[int] = Field(default=None, description="Thumbnail width")
    context_link: Optional[HttpUrl] = Field(default=None, description="Context page URL")
...
class SearchQuery(BaseModel):
    ...
    total_results: Optional[str] = Field(default=None, description="Total results count")
...
class BaseSearchResponse(BaseModel):
    ...
    queries: Optional[Dict[str, List[SearchQuery]]] = Field(default=None, description="Query information")
    context: Optional[Dict[str, Any]] = Field(default=None, description="Search context")
    search_information: Optional[SearchInfo] = Field(default=None, description="Search metadata")
    spelling: Optional[Spelling] = Field(default=None, description="Spelling corrections")
...
class ImageSearchResponse(BaseSearchResponse):
    ...
    items: List[ImageSearchResult] = Field(default=[], description="Image search results")
